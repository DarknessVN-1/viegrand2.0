      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.viewTitleWeather}>
          <View style={styles.viewWeather}>
            ...
            <View style={styles.viewFoterWeather}>
              ...
              <View style={styles.rowViewFoterWeather}>
                <Text style={styles.textAddressFoterWeather}>Hồ Chí Minh</Text>
                <Text style={styles.textSubAddressFoterWeather}>25°C</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.viewBody}>
          <View style={{ flexDirection: 'row', marginHorizontal: 20, flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
            {ViewButtonFunction(require('../../assets/thuoc.png'), 'Nhắc thuốc', () => navigation.navigate('Medication'))}
            {ViewButtonFunction(require('../../assets/camera.png'), 'Camera', () => navigation.navigate('Camera'))}
            {ViewButtonFunction(require('../../assets/alert.png'), 'Khẩn cấp', () => navigation.navigate('Alert'))}
            {/* Các nút khác... */}
          </View>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  viewBody: {
    flex: 1,
    zIndex: 1,
    paddingBottom: 20, // Giảm paddingBottom từ 120 xuống 20
  },
